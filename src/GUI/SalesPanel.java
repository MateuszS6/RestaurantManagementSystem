...
/**
 * The SalesPanel class represents the sales statistics panel in the Lancaster's Restaurant Management system.
 * It allows users to view and analyze sales data, including daily averages, annual totals, and revenue predictions.
 * The class extends MyPanel to inherit database connection functionality.
 */
public class SalesPanel extends MyPanel {
    /**
     * The main JPanel associated with the sales panel.
     */
    private JPanel mainPanel;

    /**
     * The tabbed pane to display different sales graphs and statistics.
     */
    private JTabbedPane tabbedPane;

    /**
     * The combo box to select different days for viewing average bookings.
     */
    private JComboBox bookingsComboBox;

    /**
     * The combo box to select different days for viewing average covers.
     */
    private JComboBox coversComboBox;

    /**
     * The label displaying the average bookings for the selected day.
     */
    private JLabel dayBookingsLabel;

    /**
     * The label displaying the average covers for the selected day.
     */
    private JLabel dayCoversLabel;

    /**
     * The label displaying the annual bookings total.
     */
    private JLabel annualBookingsLabel;

    /**
     * The label displaying the annual covers total.
     */
    private JLabel annualCoversLabel;

    /**
     * The panel to display the bookings graph.
     */
    private JPanel bookingsGraphTab;

    /**
     * Constructs a new SalesPanel object with the specified parent panel.
     *
    ...
    /**
     * Creates a time series chart to display the booking pattern based on historical data.
     * The chart includes the number of covers over time.
     */
    ...
    /**
     * Creates a line chart to display the popularity and revenue of dishes.
     * The chart includes separate lines for quantity sold and revenue generated by each dish.
     */
    ...
    /**
     * Creates a time series chart to display historical booking data and forecasted bookings.
     * The chart includes both historical booking trends and forecasted bookings for future dates.
     */
